      ...
      <div class="col-md-5">
        ...
        <div class="panel panel-default text-center">
          ...
          <div class="panel-body">
            <img src="./src/images/contact/contactenos_referencia.png" alt="Referencia" class="img-fluid img-thumbnail contact_i">
        ...
        <div class="panel panel-default text-center">
          ...
          <div class="panel-body">
            <img src="./src/images/contact/contactenos_admisiones.png" alt="Admisiones" class="img-fluid img-thumbnail contact_i">
        ...
        <div class="panel panel-default text-center">
          ...
          <div class="panel-body">
            <img src="./src/images/contact//contactenos_consulta.png" alt="Consulta externa" class="img-fluid img-thumbnail contact_i">
        ...
        <form class="clearfix mt50" role="form" method="post" action="../model/contact.php" name="contactform" id="contactform">
          ...
          <div class="form-group">
            ...
            <select name="subject" id="subject" class="form-control">
              ...
              <option value="a Room">Interés laboral</option>
          ...
          <div class="form-group">
            ...
            <input name="verify" type="text" id="verify" value="" class="form-control" placeholder="Por favor ingresar la respuesta" />
          </div>
